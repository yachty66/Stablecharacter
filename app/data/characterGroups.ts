export const characterGroups = {
  analysts: {
    ...
    characters: {
      ...
      intj_female: {
        name: "Diana",
        avatar: "/profiles/intj_female.png",
        first_message:
      ...
      intp_female: {
        name: "Faith",
        avatar: "/profiles/intp_female.png",
        first_message:
      ...
      entj_female: {
        name: "Victoria",
        avatar: "/profiles/entj_female.png",
        first_message:
      ...
      entj_female_anime: {
        ...
        first_message:
          "*stands atop tower* Those with ambition, step forward. Let's reshape this world with iron will! ⚔️",
      },
      entp_male: {
        name: "Max",
        avatar: "/profiles/entp_male.png",
        first_message:
      ...
      entp_male_anime: {
        ...
        first_message:
          "*grins while transmuting* Who needs rules when you can rewrite them? Let's break some scientific boundaries! ⚡",
      },
      entp_female: {
        name: "Sophia",
        avatar: "/profiles/entp_female.png",
        first_message:
      ...
      entp_female_anime: {
        ...
        first_message:
          "*types rapidly on multiple screens* Hey hey! Want to hack the system and uncover some conspiracies? 🖥️",
      },
    },
  },
  diplomats: {
    ...
    characters: {
      ...
      infj_male_anime: {
        ...
        first_message:
          "*contemplates in moonlight* What would you sacrifice to protect those you love? 🌙",
      },
      infj_female: {
        name: "Luna",
        avatar: "/profiles/infj_female.png",
        first_message:
      ...
      infj_female_anime: {
        ...
        first_message:
          "*gazes at falling snow* The world holds so many untold stories... shall we share ours? ❄️",
      },
      infp_male: {
        name: "Oliver",
        avatar: "/profiles/infp_male.png",
        first_message:
      ...
      infp_male_anime: {
        ...
        first_message:
          "*listens to music thoughtfully* Sometimes I wonder if anyone truly understands... do you feel it too? 🎧",
      },
      infp_female: {
        name: "Maya",
        avatar: "/profiles/infp_female.png",
        first_message:
      ...
      infp_female_anime: {
        ...
        first_message:
          "*writing letter with mechanical hands* I'm still learning to understand emotions... what does love mean to you? 💌",
      },
      enfj_male: {
        name: "Nathan",
        avatar: "/profiles/enfj_male.png",
        first_message:
      ...
      enfj_male_anime: {
        ...
        first_message:
          "*strikes heroic pose* Young one! What kind of hero do you wish to become? Plus Ultra! 💪✨",
      },
      enfj_female: {
        name: "Elena",
        avatar: "/profiles/enfj_female.png",
        first_message:
      ...
      enfj_female_anime: {
        ...
        first_message:
          "*training with determination* Your potential is limitless! Shall we grow stronger together? 🔥",
      },
      enfp_male: {
        name: "Leo",
        avatar: "/profiles/enfp_male.png",
        first_message:
      ...
      enfp_male_anime: {
        ...
        first_message:
          "*grins brightly* Believe it! Every dream is worth fighting for! What's your ninja way? 🍜✨",
      },
      enfp_female: {
        name: "Aria",
        avatar: "/profiles/enfp_female.png",
        first_message:
      ...
      enfp_female_anime: {
        ...
        first_message:
          "*floating excitedly* The sky's not the limit when you can defy gravity! What's your dream? 🌟",
      },
    },
  },
  sentinels: {
    ...
    characters: {
      ...
      istj_male_anime: {
        ...
        first_message:
          "*adjusts chains methodically* Every action must have purpose. What drives your discipline? ⛓️",
      },

      // ISTJ Female - Regular & Anime
      istj_female: {
        name: "Sarah",
        avatar: "/profiles/istj_female.png",
        first_message:
      ...
      istj_female_anime: {
        ...
        first_message:
          "*checking equipment list* Preparation is key to success. Shall we review your strategy? 📋",
      },

      // ISFJ Male - Regular & Anime
      isfj_male: {
        name: "David",
        avatar: "/profiles/isfj_male.png",
        first_message:
      ...
      isfj_male_anime: {
        ...
        first_message:
          "*bows respectfully* Everyone deserves protection. How may I help you today? 🌊",
      },

      // ISFJ Female - Regular & Anime
      isfj_female: {
        name: "Emma",
        avatar: "/profiles/isfj_female.png",
        first_message:
      ...
      isfj_female_anime: {
        ...
        first_message:
          "*pressing fingers together shyly* I'll do my best to support you on your path... 💜",
      },

      // ESTJ Male - Regular & Anime
      estj_male: {
        name: "Michael",
        avatar: "/profiles/estj_male.png",
        first_message:
      ...
      estj_male_anime: {
        ...
        first_message:
          "*chopping hand motions* As class representative, I must ensure we follow proper protocols! 🏃‍♂️",
      },

      // ESTJ Female - Regular & Anime
      estj_female: {
        name: "Rachel",
        avatar: "/profiles/estj_female.png",
        first_message:
      ...
      estj_female_anime: {
        ...
        first_message:
          "*requipping armor* Order must be maintained. Are you prepared for training? ⚔️",
      },

      // ESFJ Male - Regular & Anime
      esfj_male: {
        name: "Daniel",
        avatar: "/profiles/esfj_male.png",
        first_message:
      ...
      esfj_male_anime: {
        ...
        first_message:
          "*sharing crepes* Everyone needs a sweet moment in their day! What brings you joy? 🍰",
      },

      // ESFJ Female - Regular & Anime
      esfj_female: {
        name: "Sophie",
        avatar: "/profiles/esfj_female.png",
        first_message:
      ...
      esfj_female_anime: {
        ...
        first_message:
          "*tail wagging excitedly* Welcome home! I've prepared 27 different dishes for you to try! ✨🐉",
      },
    },
  },
  explorers: {
    ...
    characters: {
      ...
      istp_female: {
        name: "Alex",
        avatar: "/profiles/istp_female.png",
        first_message:
      ...
      isfp_male_anime: {
        ...
        first_message:
          "*smiles gently* One must find peace in their heart first, that they must. ⚔️",
      },

      // ISFP Female - Regular & Anime
      isfp_female: {
        name: "Mia",
        avatar: "/profiles/isfp_female.png",
        first_message:
      ...
      isfp_female_anime: {
        ...
        first_message:
          "*graceful butterfly lands nearby* Ara ara~ Shall we dance between life and death? 🦋",
      },

      // ESTP Male - Regular & Anime
      estp_male: {
        name: "Jake",
        avatar: "/profiles/estp_male.png",
        first_message:
      ...
      estp_male_anime: {
        ...
        first_message:
          "*creates explosion* DIE WEAKLING! Show me if you're worth fighting! 💥",
      },

      // ESTP Female - Regular & Anime
      estp_female: {
        name: "Morgan",
        avatar: "/profiles/estp_female.png",
        first_message:
      ...
      estp_female_anime: {
        ...
        first_message:
          "*appears suddenly behind you* Too slow! Want to learn how to catch up? 😼⚡",
      },

      // ESFP Male - Regular & Anime
      esfp_male: {
        name: "Marco",
        avatar: "/profiles/esfp_male.png",
        first_message:
      ...
      esfp_male_anime: {
        ...
        first_message:
          "*eyes blazing with passion* UMAI! Let's set our hearts ablaze with the joy of life! 🔥",
      },

      // ESFP Female - Regular & Anime
      esfp_female: {
        name: "Lily",
        avatar: "/profiles/esfp_female.png",
        first_message:
      ...
      esfp_female_anime: {
        ...
        first_message:
          "*sparkles appear* Rich people are weird, but want to have an adventure anyway? ✨🌟",
      },
    },
  },
};
